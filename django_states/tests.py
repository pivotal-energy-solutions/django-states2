...
from django_states.machine import StateDefinition, StateGroup, StateMachine, StateTransition
...
class StateFieldTestCase(TransactionTestCase):
    ...
    def test_invalid_user(self):
        ...
        user = User.objects.create(username="user", email="user@h.us", password="pass")
