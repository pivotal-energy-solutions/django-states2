...
setup(
    ...
    description='State machine for django models',  # Required
    ...
    #
    packages=find_packages(exclude=['contrib', 'docs', 'tests', 'test_proj']),  # Required
    ...
    install_requires=['django>=1.11,<3.0'],  # Optional
